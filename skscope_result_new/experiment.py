...
if __name__ == "__main__":
    ...
    if False:
        ...
        experiment.check(model="additive", n=1000, p=100, k=10, seed=1)
        #experiment.check(model="non_additive", n=100, p=100, k=3, seed=1)
        #experiment.check(model="trend_filter", n=100, p=100, k=1, seed=1)
        #experiment.check(model="linear", n=20, p=50, k=5, seed=10)
        #experiment.check(model="logistic", n=20, p=50, k=5, seed=100)
        #experiment.check(model="ising", n=20, p=10, k=4, seed=708)
    else:
